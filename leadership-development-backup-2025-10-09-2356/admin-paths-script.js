...
function updateNavigation() {
    ...
    if (user.role === 'Admin') {
        navigationHTML = '<a href="user-dashboard.html" class="nav-link">Dashboard</a><a href="my-progress.html" class="nav-link">My Progress</a><a href="admin-paths.html" class="nav-link active">Manage Paths</a><a href="admin.html" class="nav-link">Admin Console</a>';
    } else {
        navLinks.innerHTML = '<a href="index.html" class="nav-link">Login</a>';
        return;
    }
